                        ...
                        <form method="post">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fullname" id="fullname" size="45" class="form-control" required/>
                                </div>
                                <div class="form-group">
                                    <label>Date Of Birth</label>
                                    <input type="date" class="form-control"  name="dateofbirth" id="dateofbirth" size="45" required>
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
                                    <input type="text" class="form-control"  name="address" id="address" size="45" required>
                                </div>
                                <div class="form-group">
                                    <label>Gender</label>
                                    <input type="text" class="form-control"  name="gender" id="gender" size="45" required>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  name="phonenumber" id="phonenumber" size="45" required>
                                </div>
                                <div class="form-group">
                                    <label>CMT</label>
                                    <input type="text" class="form-control"  name="cmt" id="cmt" size="45" required>
                                </div>
                                <div class="form-group">
...
<%String str = "<script>alert('Customer add successfully')</script>";%>
<%=str%>
<%}%>
