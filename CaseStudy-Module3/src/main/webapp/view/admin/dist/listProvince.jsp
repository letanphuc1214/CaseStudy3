                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8 row-logo" style="display: flex;">
                                    <div class="logo-content"><h2>Province List</h2></div>

                                </div>
                                <div class="col-sm-4">
                                    <a href="${pageContext.request.contextPath}/provinces/add" class="btn btn-success"><i
                                            class="material-icons">&#xE147;</i> <span>Add New Province</span></a>
                                </div>
                            </div>
                        </div>
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach var="province" items="${listProvince}">
                                <tr>
                                    <td>${province.getIdProvince()}</td>
                                    <td>${province.getProvinceName()}</td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/provinces/delete?id=${province.idProvince}" class="delete"><i
