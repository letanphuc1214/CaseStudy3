...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="navbar-brand" href="${pageContext.request.contextPath}/customers">Customer Manager</a>
                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <a href="${pageContext.request.contextPath}/customers" class="btn btn-success"><i
                                            class="material-icons">&#xE147;</i> <span>Back Customer List</span></a>
                                </div>
                            </div>
                        </div>
...
<script src="/view/admin/dist/assets/demo/datatables-demo.js"></script>
</body>
</html>
