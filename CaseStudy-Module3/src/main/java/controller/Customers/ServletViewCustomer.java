...
@WebServlet(name = "ServletViewCustomer", urlPatterns = "/customers/view")
public class ServletViewCustomer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Province> listCategory = null;
        try {
            listCategory = provinceDAO.findAll();
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/view/admin/dist/view.jsp");
